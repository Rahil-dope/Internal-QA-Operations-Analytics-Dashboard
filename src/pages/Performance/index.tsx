...
export const KpiDashboard: React.FC = () => {
  const { filteredPerformance, loading, dataset } = useExcelData();
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg min-h-[300px] text-center max-w-md mx-auto my-12 shadow-sm animate-fade-in select-none">
        ...
        <div className="mt-5">
          <Link 
            to="/upload" 
            className="inline-flex items-center justify-center rounded-md text-xs font-semibold px-4 h-9 bg-indigo-655 hover:bg-indigo-755 text-white transition-colors"
          >
            Upload Workbook
          </Link>
        </div>
